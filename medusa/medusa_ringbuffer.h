...
#ifndef _MEDUSA_RINGBUFFER_H
#define _MEDUSA_RINGBUFFER_H
 ...
 *
 * This ringbuffer is based on Jack ringbuffer from Paul Davis / Rohan Drape
 */

typedef struct medusa_ringbuffer t_medusa_ringbuffer;
typedef struct medusa_ringbuffer_data t_medusa_ringbuffer_data;

struct medusa_ringbuffer_data{
  char  *buf;
  size_t len;
};


struct medusa_ringbuffer {
  char		 *buf;
 ...
 * otherwise.
 */
t_medusa_ringbuffer *medusa_ringbuffer_create(
      size_t sz
      );
 ...
 */
void medusa_ringbuffer_read_advance(
      t_medusa_ringbuffer *rb,
      size_t cnt
      );
 ...
 */
size_t medusa_ringbuffer_read_space(
      const t_medusa_ringbuffer *rb
      );
 ...
 */
void medusa_ringbuffer_write_advance(
      t_medusa_ringbuffer *rb,
      size_t cnt
      );
 ...
 */
size_t medusa_ringbuffer_write_space(
      const t_medusa_ringbuffer *rb
      );

#endif //MEDUSA_RINGBUFFER
